import { useWorldChatInfinityScroll, useWorldChatQuery } from "@shared/state/queries/hooks/useWorldChatQuery";
...
export const WorldChatList = () => {
  ...
  return (
    <div>
      <SelectBox value={channel} options={OPTIONS} onChange={handleChangeSelectBox} />
