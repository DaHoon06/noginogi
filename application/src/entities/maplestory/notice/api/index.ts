...
} from '@entities/maplestory/notice/typings';
 ...
 * @description 이벤트 조회
 * */
export const eventNoticeListApi = async (): Promise<
  ResponseEventNoticeListType[]
> => {
  const url = '/maplestory/notice/event/list';
  const result: AxiosResponse<{ data: ResponseEventNoticeListType[] }> =
    await axiosInstance.get(url);
  return result.data.data;
};
/**
 ...
 * */
export const cashshopNoticeListApi = async (): Promise<
  ResponseCashshopNoticeListType[]
> => {
  const url = '/maplestory/notice/cashshop/list';
  const result: AxiosResponse<{ data: ResponseCashshopNoticeListType[] }> =
    await axiosInstance.get(url);
  return result.data.data;
};
/**
 ...
 * */
export const updateNoticeListApi = async (): Promise<
  ResponseUpdateNoticeListType[]
> => {
  const url = '/maplestory/notice/update/list';
  const result: AxiosResponse<{ data: ResponseUpdateNoticeListType[] }> =
    await axiosInstance.get(url);
  return result.data.data;
};
